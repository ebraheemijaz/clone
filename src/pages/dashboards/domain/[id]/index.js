    ...
    <>
      ...
      >
        <Box>
          ...
          <Typography
            variant='body2'
            sx={{ color: 'white', fontSize: '1.25rem', display: 'flex', gap: 2, alignItems: 'center' }}
          >
            <Icon fontSize='1.25rem' icon='tabler:world' />
            website-category
          </Typography>
        </Box>
        <Card
          ...
          <Grid container spacing={6}>
            <Grid item xs={12} sm={12}>
              <Card>
                <CardHeader
                  title={
                    <Typography variant='body2' sx={{ fontSize: '1.125rem', fontWeight: 'bold' }}>
                      General Information
                    </Typography>
                  }
                />
