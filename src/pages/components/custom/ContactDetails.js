                    ...
                    {data[value].map((item, index) => {
                        ...
                        return (
                            <Fragment key={index}>
                                <DivContainer>
                                    <Div>
                                        <Typography fontSize={18} sx={{ mb: 0.5 }} variant='p'>{item.phone1.type}</Typography>
                                ...
                                <DivContainer>
                                    <Div>
                                        <Typography fontSize={18} sx={{ mb: 0.5 }} variant='p'>{item.phone2.type}</Typography>
                                        <Typography sx={{ color: 'text.disabled' }}>{item.phone1.number}</Typography>
                                    </Div>
                                    <Divider sx={{ borderStyle: 'dashed' }} />
                                </DivContainer>
                                <DivContainer>
                                    <Div>
                                        <Typography fontSize={18} sx={{ mb: 0.5 }} variant='p'>{item.mobile.type}</Typography>
                                        <Typography sx={{ color: 'text.disabled' }}>{item.phone1.number}</Typography>
                                    </Div>
                                    <Divider sx={{ borderStyle: 'dashed' }} />
                                </DivContainer>
                                <DivContainer>
                                    <Div>
                                        <Typography fontSize={18} sx={{ mb: 0.5 }} variant='p'>{item.fax.type}</Typography>
                                        <Typography sx={{ color: 'text.disabled' }}>{item.phone1.number}</Typography>
                                    </Div>
                                </DivContainer>
                            </Fragment>
